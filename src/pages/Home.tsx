                ...
                <section className="py-24 bg-white">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl lg:text-5xl font-bold mb-4 tracking-tight text-slate-900">How it Works</h2>
                            <p className="text-slate-600 max-w-2xl mx-auto text-lg">Three simple steps to deploy an intelligent, adaptive assessment engine in your product.</p>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                            {/* Step 1 */}
                            <div className="flex flex-col items-center text-center p-8 rounded-2xl border border-slate-100 bg-white shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                                <div className="w-16 h-16 rounded-full bg-blue-50 text-primary flex items-center justify-center mb-6">
                                    <span className="material-symbols-outlined text-3xl">upload_file</span>
                                </div>
                                <h3 className="text-xl font-bold mb-3 text-slate-900">1. Upload Content</h3>
                            ...
                            <div className="flex flex-col items-center text-center p-8 rounded-2xl border border-slate-100 bg-white shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                                ...
                                <h3 className="text-xl font-bold mb-3 text-slate-900">3. Assess & Adapt</h3>
                                <p className="text-slate-600 text-sm leading-relaxed">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            {[
                                ...
                                <div key={idx} className="bg-white p-8 rounded-2xl border border-slate-200 group hover:border-primary/50 transition-all hover:shadow-lg h-full">
